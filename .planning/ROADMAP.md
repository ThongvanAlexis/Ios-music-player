...
**Goal:** Import and play the required local audio formats on the user's iPhone through a reproducible macOS build route, with a native player and system controls.
**Mode:** mvp
...
|-------|----------------|--------|-----------|
| 1. Installable Native Player | 0/TBD | Not started | - |
