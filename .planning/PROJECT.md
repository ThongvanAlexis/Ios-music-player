...
Working title only; the app has no final name yet. The product decisions below are confirmed unless explicitly identified as planning defaults or implementation questions. The initial requirements and roadmap are being prepared for review.
...
The roadmap is organized around working user capabilities. Its proposed phase structure remains reviewable before the initial roadmap commit.
...
---
*Last updated: 2026-09-12 after playback-mode and fixed-layout skin decisions.*
